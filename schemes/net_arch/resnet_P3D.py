...
__all__ = [
    'ResNetP3', 'resnet10', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
    'resnet152', 'resnet200'
]
...
def resnet10(**kwargs):
    ...
    """
    model = ResNetP3(BasicBlock, [1, 1, 1, 1], **kwargs)
    return model
...
def resnet18(**kwargs):
    """Constructs a ResNet-18 model.
    """
    model = ResNetP3(BasicBlock, [2, 2, 2, 2], **kwargs)
    return model
...
def resnet34(pretrained=False, **kwargs):
    ...
    """
    model = ResNetP3(BasicBlock, [3, 4, 6, 3], **kwargs)
    return model
...
def resnet50(pretrained=True, **kwargs):
    ...
    """
    model = ResNetP3(Bottleneck, [3, 4, 6, 3], **kwargs)
...
def resnet101(**kwargs):
    ...
    """
    model = ResNetP3(Bottleneck, [3, 4, 23, 3], **kwargs)
    return model
...
def resnet152(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = ResNetP3(Bottleneck, [3, 8, 36, 3], **kwargs)
    return model
...
def resnet200(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = ResNetP3(Bottleneck, [3, 24, 36, 3], **kwargs)
    return model
