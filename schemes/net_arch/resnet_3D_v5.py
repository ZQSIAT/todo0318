...
__all__ = [
    'ResNet_V5', 'resnet10', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
    'resnet152', 'resnet200'
]
...
class LayerChunk(nn.Module):
    def __init__(self, block, inplanes, planes, block_num, stride=1):
        super(LayerChunk, self).__init__()
...
class ResNet_V5(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer1 = LayerChunk(block, 64, 64, layers[0], stride=1)
        self.layer2 = LayerChunk(block, 64*block.expansion, 128, layers[1], stride=2)
        self.layer3 = LayerChunk(block, 128*block.expansion, 256, layers[2], stride=2)
        self.layer4 = LayerChunk(block, 256*block.expansion, 512, layers[3], stride=2)
        ...
        #     block, 256, layers[2], shortcut_type, stride=(2, 2, 2))
        #
        # self.layer4 = self._make_layer(
        #     block, 512, layers[3], shortcut_type, stride=(2, 2, 2))
...
def resnet10(**kwargs):
    ...
    """
    model = ResNet_V5(BasicBlock, [1, 1, 1, 1], **kwargs)
    return model
...
def resnet18(**kwargs):
    """Constructs a ResNet-18 model.
    """
    model = ResNet_V5(BasicBlock, [2, 2, 2, 2], **kwargs)
    return model
...
def resnet34(pretrained=False, **kwargs):
    ...
    """
    model = ResNet_V5(BasicBlock, [3, 4, 6, 3], **kwargs)
    return model
...
def resnet50(pretrained=True, **kwargs):
    ...
    """
    model = ResNet_V5(Bottleneck, [3, 4, 6, 3], **kwargs)
...
def resnet101(**kwargs):
    ...
    """
    model = ResNet_V5(Bottleneck, [3, 4, 23, 3], **kwargs)
    return model
...
def resnet152(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = ResNet_V5(Bottleneck, [3, 8, 36, 3], **kwargs)
    return model
...
def resnet200(**kwargs):
    """Constructs a ResNet-101 model.
    """
    model = ResNet_V5(Bottleneck, [3, 24, 36, 3], **kwargs)
    return model
