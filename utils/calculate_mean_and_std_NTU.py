...
if __name__ == "__main__":
    ...
    index_param["data_dosage"] = 0.1
    index_param["small_validation"] = True
    index_param["file_format"] = "/data/xp_ji/datasets/ntu_rgb+d/depth_masked"
    index_param[
        "file_subset_list"] = "/home/xp_ji/workspace/deployment/action-net/{data_name:s}_output/" \
                              "protocols/{data_name:s}_2_cross_view_{subset:s}.txt".format(data_name=data_name,
                                                                                               subset=subset)
